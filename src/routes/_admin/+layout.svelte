...
<div class="bg-background flex min-h-screen flex-col">
	<!-- Top Header Bar -->
	<header class="bg-card border-b sticky top-0 z-20 shadow-sm">
	...
	<div class="flex flex-1">
		<!-- Sidebar Navigation -->
		<aside
			class="bg-sidebar text-sidebar-foreground fixed top-16 bottom-0 z-10 w-64 flex-shrink-0 border-r transition-transform duration-300 ease-in-out md:sticky {sidebarOpen
				? 'translate-x-0'
