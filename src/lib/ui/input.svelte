<script lang="ts">
	...
	const classes =
		'w-full border-input h-8 bg-input text-foreground placeholder:text-muted-foreground resize-y rounded-lg border px-2 py-1 font-sans text-base transition focus:ring-primary/40 focus:ring-2 focus:outline-none';
</script>
