...
INSERT INTO "new_event" ("address", "createdAt", "eventTypeId", "id", "maxUsers", "registerUntil", "startsAt", "trackId", "updatedAt") SELECT "address", "createdAt", "eventTypeId", "id", "maxUsers", "registerUntil", "startsAt", "trackId", "updatedAt" FROM "event";
DROP TABLE "event";
